...
define([
    ...
    var testSuiteClass = function (viewObj, suiteConfig){
        ...
        if (templateConfig.templateGenerator == "RowSectionTemplateGenerator") {
            if (contrail.checkIfExist(templateConfig.advacedViewOptions) && templateConfig.advacedViewOptions) {
            ...
            console.log("No Core DetailsView Tests implemented for Template generator: " + templateConfig.templateGenerator);
        }
