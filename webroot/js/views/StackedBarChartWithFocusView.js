...
define([
    ...
    var stackedBarChartWithFocusChartView = ContrailView.extend({
        ...
        renderChart: function (selector, viewConfig, chartViewModel) {
            ...
            //NOT used as of now showing colors from the data itself - only red and orange as only these two are used currently.
            var colour = d3.scale.ordinal().range(getValueByJsonPath(viewConfig,'chartOptions;colors',
                    ["#dc6660","#ffbf87",]));
            ...
            var xAxis = d3.svg.axis()
                            ...
                            .outerTickSize(0)
                            .tickPadding(10)
//                            .tickFormat(d3.time.format('%e %b %H %M '))
