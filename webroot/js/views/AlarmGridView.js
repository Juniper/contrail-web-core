        ...
        var alarmColumns = [
                              {
                                  ...
                                  formatter : function (r, c, v, cd, dc) {
                                      ...
                                      if(dc['ack']) {
                                          if(dc['severity'] === 4) {
                                              formattedDiv = '<div data-color="orange" class="circle orange circle-grid-style"></div>';
                                          } else if (dc['severity'] === 3) {
                                              formattedDiv = '<div data-color="red" class="circle red circle-grid-style"></div>';
                                          }
                                      } else {
                                          if(dc['severity'] === 3) {
                                              formattedDiv = '<div data-color="red" class="circle red filled circle-grid-style"></div>';
                                          } else if (dc['severity'] === 4) {
                                              formattedDiv = '<div data-color="orange" class="circle orange filled circle-grid-style"></div>';
                                          }
                                      }
                                      return formattedDiv;
                                  }
