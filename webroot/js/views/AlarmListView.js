    ...
    var AlarmListView = ContrailView.extend({
        ...
        render: function () {
            ...
            function onUpdateAlarmsUIListModel() {
                if(alarmsUIListModel.updateFromcrossFilter != true) {
                    var selRecords = alarmsUIListModel.getFilteredItems();
                    var selIds = $.map(selRecords,function(obj,idx) {
                        return obj.token;
                    });

                    self.alarmsListModel.updateFromUIListModel = true;
                    ...
                    alarmsUIListModel.updateFromcrossFilter = false;
                }
            }
            ...
            cfDataSource.addCallBack('updateCFListModel',function(data) {
                ...
                if(data['cfg']['source'] == 'crossFilter')
                    alarmsUIListModel.updateFromcrossFilter = true;
            });
                        ...
                        columns: [
                            {
                                ...
                                viewConfig: {
                                    ...
                                    parseFn : coreAlarmUtils.parseAlarmsDataForStackChart,
