requirejs.config({
    ...
    paths: {
        ...
        'multiselect'               : "/assets/2way-multiselect/js/multiselect",
...
require(['jquery','jquery-ui','jquery.xml2json','jquery.ba-bbq','jquery.timer','jquery.ui.touch-punch',
        ...
        'slick.grid','slick.enhancementpager','jquery.datetimepicker','moment','multiselect',
        ...
        'qe-utils','nvd3-plugin','d3-utils','analyzer-utils','dashboard-utils','ipv6'],function(contrail) {
});
