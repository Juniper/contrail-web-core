 ...
 * @param {Object[][]} data
 */
contrailD3.NavigationChart = function(config, data) {
...
contrailD3.NavigationChart.prototype = Object.create(contrailD3.Container.prototype);
 ...
 */
contrailD3.NavigationChart.prototype._renderNavigationChart = function() {
 ...
 * @returns {contrailD3.Chart}
 */
contrailD3.NavigationChart.prototype._renderMainChart = function() {
 ...
 */
contrailD3.NavigationChart.prototype.render = function(selector) {
    /*
 ...
 * @protected
 */
contrailD3.NavigationChart.prototype._renderInnerMarkdown = function() {

    this._mainContainer = this._container.append("div");
    this._navigationContainer = this._container.append("div");
},


contrailD3.NavigationChart.prototype._renderSubChart = function(selector, options, hideTicks) {
    /*
     * Configure x axis.
     */
 ...
 */
contrailD3.NavigationChart.prototype.setMainChartHeight = function(height) {
 ...
 * @returns {CpuVsMemoryChart}
 */
contrailD3.NavigationChart.prototype.setNavigationChartHeight = function(height) {
 ...
 * @returns {CpuVsMemoryChart}
 */
contrailD3.NavigationChart.prototype.add = function(component, x, y) {
...
contrailD3.NavigationChart.prototype._addChart = function(chart, x, y) {
...
contrailD3.NavigationChart.prototype._addComponent = function(component) {
