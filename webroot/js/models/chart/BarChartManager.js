 ...
 * @constructor
 */
contrailD3.BarChartManager = function(chart) {
    /**
 ...
 */
contrailD3.BarChartManager.prototype.setStrategy = function(strategy) {
 ...
 */
contrailD3.BarChartManager.prototype.remove = function(chart) {
    /*
     * Check chart class.
     */
 ...
 * @param {contrailD3.charts.BarChart} chart
 */
contrailD3.BarChartManager.prototype.add = function(chart) {
    /*
     * Check chart class.
     */
    if (chart.getClassName() != "contrailD3.charts.BarChart") {
 ...
 * @returns {Number} 
 */
contrailD3.BarChartManager.prototype.getGap = function(chart) {
 ...
 * @returns {Number}
 */
contrailD3.BarChartManager.prototype.getWidth = function(chart) {
 ...
 * @returns {Number}
 */
contrailD3.BarChartManager.prototype.getX = function(chart, d, i) {
 ...
 * @returns {Number}
 */
contrailD3.BarChartManager.prototype.getY = function(chart, d, i) {
 ...
 * @returns {Number}
 */
contrailD3.BarChartManager.prototype.getHeight = function(chart, d, i) {
