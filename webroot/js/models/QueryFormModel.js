...
define([
    ...
    var QueryFormModel = ContrailModel.extend({
        ...
        saveSelect: function (options) {
            console.log(this.select_data_object().checkedFields());
        },
            ...
            modelRemoteDataConfig = {
                remote: {
                    ...
                    setData2Model: function(contrailViewModel, response) {
                        ...
                        contrailViewModel.set({'ui_added_parameters': {
                            'table_schema': response
                        }});
                        contrailViewModel.attributes.select_data_object['select_fields'] = selectFields;
                        setEnable4SelectFields(selectFields, contrailViewModel.attributes.select_data_object['isEnableMap']);
                    }
                },
                vlRemoteConfig: {
                    vlRemoteList: []
