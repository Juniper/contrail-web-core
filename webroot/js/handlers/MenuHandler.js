    ...
    var MenuHandler = function () {
        ...
        this.toggleMenuButton = function (menuButton, currPageHash, lastPageHash, cfg) {
            ...
            if (subMenuId == null) {
                ...
                /* BreadCrumb DD */
                var ddData = [
                    {mId: 'menuL0', mData: [], mSelData: '', isL1menu: true},
                ...
                var l0Menu = $('#drop-down-l0-menu-area div:last'),
                    ...
                    pLbl = '';
                l0Menu.html('');
                /*menuObj.items.item.forEach(function (val) {
                ...
                var pLbl = '',
                    cLbl = '';
                $('#drop-down-l0-menu-area').find('.l1menu-header').each(function (v){
                   cLbl = $(this).text().toUpperCase();
                   if (pLbl.toUpperCase() == cLbl) {
                        $(this).css('color','#fff');
