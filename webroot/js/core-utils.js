...
define([
    ...
    'core-basedir/js/views/FormDropdownView', 'core-basedir/js/views/FormComboboxView', 'core-basedir/js/views/FormSelect2DropdownView', 'core-basedir/js/views/FormCheckboxView', 'core-basedir/js/views/FormRadioButtonView',
...
], function (FormInputView, FormGridView, FormDynamicGridView, FormMultiselectView, FormDropdownView, FormComboboxView, FormSelect2DropdownView, FormCheckboxView, FormRadioButtonView,
    ...
    var CoreUtils = function () {
        ...
        this.renderView = function (viewName, parentElement, model, viewAttributes, modelMap, app, rootView) {
            ...
            switch (viewName) {
                ...
                case "FormComboboxView":
                    elementView = new FormComboboxView({el: parentElement, model: model, attributes: viewAttributes, rootView: rootView});
                    elementView.modelMap = modelMap;
                    elementView.render();
                    return elementView;
