...
define([
    ...
    var columnDisplayMap  = {
        "FlowSeriesTable": [
            {select:"T", display:{id:"T", field:"T", width:180, name:"Time", filterable:false, groupable:false}},
            {select:"T=", display:{id:"T", field:"T", width:180, name:"Time", filterable:false, groupable:false}},
            {select:"vrouter", display:{id:"vrouter",field:"vrouter", width:100, name:"Virtual Router", groupable:false}},
            {select:"sourcevn", display:{id:"sourcevn",field:"sourcevn", width:110, name:"Source VN", groupable:false}},
            {select:"destvn", display:{id:"destvn", field:"destvn", width:110, name:"Destination VN", groupable:false}},
            {select:"sourceip", display:{id:"sourceip", field:"sourceip", width:85, name:"Source IP", groupable:false}},
            {select:"destip", display:{id:"destip", field:"destip", width:105, name:"Destination IP", groupable:false}},
            {select:"sport", display:{id:"sport", field:"sport", width:90, name:"Source Port", groupable:false}},
            {select:"dport", display:{id:"dport", field:"dport", width:115, name:"Destination Port", groupable:false}},
            {select:"direction_ing", display:{id:"direction_ing", field:"direction_ing", width:100, name:"Direction", groupable:true}},
            {select:"protocol", display:{id:"protocol", field:"protocol", width:75, name:"Protocol", groupable:true}},
            {select:"bytes", display:{id:"bytes", field:"bytes", width:120, name:"Bytes", groupable:false}},
            {select:"sum(bytes)", display:{id:"sum(bytes)", field:"sum(bytes)", width:95, name:"SUM (Bytes)", groupable:false}},
            ...
            {select:"sum(packets)", display:{id:"sum(packets)", field:"sum(packets)", width:110, name:"SUM (Packets)", groupable:false}},
        ...
        "FlowRecordTable": [
            ...
            {select:"setup_time", display:{id:"setup_time", field:"setup_time", width:180, name:"Setup Time", filterable:false, groupable:false}},
            {select:"teardown_time", display:{id:"teardown_time", field:"teardown_time", width:180, name:"Teardown Time", filterable:false, groupable:false}},
            {select:"vrouter", display:{id:"vrouter", field:"vrouter", width:100, name:"Virtual Router", groupable:false}},
            ...
            {select:"sourcevn", display:{id:"sourcevn", field:"sourcevn", width:110, name:"Source VN", groupable:true}},
            {select:"destvn", display:{id:"destvn", field:"destvn", width:110, name:"Destination VN", groupable:true}},
            {select:"sourceip", display:{id:"sourceip", field:"sourceip", width:85, name:"Source IP", groupable:true}},
            {select:"destip", display:{id:"destip", field:"destip", width:105, name:"Destination IP", groupable:true}},
            {select:"sport", display:{id:"sport", field:"sport", width:90, name:"Source Port", groupable:true}},
            {select:"dport", display:{id:"dport", field:"dport", width:115, name:"Destination Port", groupable:true}},
            {select:"direction_ing", display:{id:"direction_ing", field:"direction_ing", width:100, name:"Direction", groupable:true}},
            {select:"protocol", display:{id:"protocol", field:"protocol", width:80, name:"Protocol", groupable:true}},
