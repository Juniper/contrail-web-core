...
define([
    ...
    var columnDisplayMap  = {
        ...
        "FlowClass":[
            ...
            {select:"destip", display:{id:"destip", field:"destip", name:"Destination IP", minWidth: 120, formatter: function(r, c, v, cd, dc){ return cowu.handleNull4Grid(dc.destip);}}},
        ...
        "defaultObjectColumns": [
            ...
            {select: "ObjectId", display:{id:"ObjectId", field:"ObjectId", name:"Object Id", minWidth:150, searchable: true, formatter: function(r, c, v, cd, dc) { return cowu.handleNull4Grid(dc.ObjectId);}, hide: true}},
