...
function changeRegion (regionName)
{
    ...
    if(region != 'All Regions') {
        ...
        currHashState = (currHashState && currHashState.p.indexOf('_gc_') == -1) ? currHashState.p : 'mon_infra_dashboard';
        ...
        loadUtils = {
            ...
            postAuthenticate: function(response) {
                require(['jquery'],function() {
                    ...
                    var cgcEnabled = globalObj.webServerInfo.cgcEnabled;
                    if(region === "All Regions" && cgcEnabled == false){
                          //var regionlist = globalObj.webServerInfo.regionList;
                        loadUtils.setCookie('region',"");
                    }
