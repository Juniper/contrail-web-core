...
$(CONTROLLER):
	...
	cd ../src/contrail-api-client/schema/ && wget https://raw.githubusercontent.com/tungstenfabric/api-client/$(BRANCH)/schema/alarm.xsd;
	cd ../src/contrail-api-client/schema/ && wget https://raw.githubusercontent.com/tungstenfabric/api-client/$(BRANCH)/schema/all_cfg.xsd;
	cd ../src/contrail-api-client/schema/ && wget https://raw.githubusercontent.com/tungstenfabric/api-client/$(BRANCH)/schema/bfd_schema.xsd;
	cd ../src/contrail-api-client/schema/ && wget https://raw.githubusercontent.com/tungstenfabric/api-client/$(BRANCH)/schema/bgp_schema.xsd;
	cd ../src/contrail-api-client/schema/ && wget https://raw.githubusercontent.com/tungstenfabric/api-client/$(BRANCH)/schema/bgpvpn.xsd;
	cd ../src/contrail-api-client/schema/ && wget https://raw.githubusercontent.com/tungstenfabric/api-client/$(BRANCH)/schema/e2_services.xsd;
	cd ../src/contrail-api-client/schema/ && wget https://raw.githubusercontent.com/tungstenfabric/api-client/$(BRANCH)/schema/firewall_policy.xsd;
	cd ../src/contrail-api-client/schema/ && wget https://raw.githubusercontent.com/tungstenfabric/api-client/$(BRANCH)/schema/ietf-bfd-schema.xsd;
	cd ../src/contrail-api-client/schema/ && wget https://raw.githubusercontent.com/tungstenfabric/api-client/$(BRANCH)/schema/ietf-l3vpn-schema.xsd;
	cd ../src/contrail-api-client/schema/ && wget https://raw.githubusercontent.com/tungstenfabric/api-client/$(BRANCH)/schema/loadbalancer.xsd;
	cd ../src/contrail-api-client/schema/ && wget https://raw.githubusercontent.com/tungstenfabric/api-client/$(BRANCH)/schema/routing_policy.xsd;
	cd ../src/contrail-api-client/schema/ && wget https://raw.githubusercontent.com/tungstenfabric/api-client/$(BRANCH)/schema/services.xsd;
	cd ../src/contrail-api-client/schema/ && wget https://raw.githubusercontent.com/tungstenfabric/api-client/$(BRANCH)/schema/smi-base.xsd;
	cd ../src/contrail-api-client/schema/ && wget https://raw.githubusercontent.com/tungstenfabric/api-client/$(BRANCH)/schema/structured_syslog_config.xsd;
	cd ../src/contrail-api-client/schema/ && wget https://raw.githubusercontent.com/tungstenfabric/api-client/$(BRANCH)/schema/tag.xsd;
	cd ../src/contrail-api-client/schema/ && wget https://raw.githubusercontent.com/tungstenfabric/api-client/$(BRANCH)/schema/usr_def_cntr.xsd;
	cd ../src/contrail-api-client/schema/ && wget https://raw.githubusercontent.com/tungstenfabric/api-client/$(BRANCH)/schema/vnc_cfg.xsd;
	cd ../src/contrail-api-client/schema/ && wget https://raw.githubusercontent.com/tungstenfabric/api-client/$(BRANCH)/schema/xmpp_enet.xsd;
	cd ../src/contrail-api-client/schema/ && wget https://raw.githubusercontent.com/tungstenfabric/api-client/$(BRANCH)/schema/xmpp_multicast.xsd;
	cd ../src/contrail-api-client/schema/ && wget https://raw.githubusercontent.com/tungstenfabric/api-client/$(BRANCH)/schema/xmpp_mvpn.xsd;
	cd ../src/contrail-api-client/schema/ && wget https://raw.githubusercontent.com/tungstenfabric/api-client/$(BRANCH)/schema/xmpp_unicast.xsd;
