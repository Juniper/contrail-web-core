...
config.networkManager.ip = '10.84.25.27';
...
config.cnfg = {};
config.cnfg.server_ip = '10.84.25.27';
...
config.analytics = {};
config.analytics.server_ip = '10.84.25.29';
...
/* Cassandra Server */
config.cassandra = {};
config.cassandra.server_ips = ['10.84.25.27', '10.84.25.28', '10.84.25.29'];
...
config.featurePkg.webController.path = '/Users/absingla/Work/forked-master/contrail-web-controller';
config.featurePkg.webController.enable = true;

config.featurePkg.serverManager = {};
config.featurePkg.serverManager.path = '/Users/absingla/Work/forked-master/contrail-web-server-manager';
